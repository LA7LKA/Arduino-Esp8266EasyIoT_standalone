...
Esp8266EasyIoTMsg dimmerMsg(1, V_DIMMER);
Esp8266EasyIoTMsg lightMsg(1, V_DIGITAL_VALUE);
...
void setup()
{
  ...
  esp.begin(incomingMessage, 3, &Serial, &Serial);
  ...
  esp.present(1, S_DIMMER );
  // request last dimmer value
  esp.request( 1, V_DIMMER );
}
